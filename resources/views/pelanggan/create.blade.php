<x-app-layout>
    ...
    <div class="max-w-2xl">
        <form action="{{ route('pelanggan.store') }}" method="POST" class="bg-surface border border-line rounded p-6 space-y-4">
            @csrf

            <div>
                <label for="nama_pelanggan" class="block text-sm font-medium text-ink mb-1">Nama Pelanggan</label>
                <input type="text" id="nama_pelanggan" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}" class="input-field" required>
            ...
            <div>
                ...
                <input type="text" id="wilayah" name="wilayah" value="{{ old('wilayah') }}" class="input-field">
            ...
            <div>
                ...
                <textarea id="alamat" name="alamat" rows="3" class="input-field">{{ old('alamat') }}</textarea>
            ...
            <div>
                ...
                <input type="text" id="no_telepon" name="no_telepon" value="{{ old('no_telepon') }}" class="input-field">
            ...
            <div>
                ...
                <input type="text" id="batas_kredit" name="batas_kredit" value="{{ old('batas_kredit') }}" class="input-field font-mono text-right" inputmode="numeric">
